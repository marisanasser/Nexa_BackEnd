...
class ReviewController extends Controller
{
    ...
    public function index(Request $request): JsonResponse
    {
        ...
        try {
            ...
            if ('true' === $publicOnly || '1' === $publicOnly || true === $publicOnly) {
            ...
            $ratingDistribution = $this->getRatingDistribution($user->id, 'true' === $publicOnly || '1' === $publicOnly || true === $publicOnly);
    ...
    public function getContractReviewStatus(int $contractId): JsonResponse
    {
        try {
            ...
            if ($user->id === $contract->brand_id) {
                $data['can_review'] = !$contract->hasBrandReview() && 'completed' === $contract->status;
                ...
                $data['can_review'] = !$contract->hasCreatorReview() && 'completed' === $contract->status;
