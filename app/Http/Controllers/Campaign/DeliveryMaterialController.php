...
class DeliveryMaterialController extends Controller
{
    ...
    public function store(Request $request): JsonResponse
    {
        ...
        try {
            ...
            ContractNotificationService::notifyBrandOfNewDeliveryMaterial($material);
    ...
    public function approve(Request $request, DeliveryMaterial $material): JsonResponse
    {
        ...
        if ('brand' !== $user->role || $material->brand_id !== $user->id) {
            return response()->json(['message' => 'Unauthorized'], 403);
        }
        ...
        try {
            ...
            ContractNotificationService::notifyCreatorOfDeliveryMaterialApproval($material);
            ContractNotificationService::notifyBrandOfDeliveryMaterialAction($material, 'approved');
    ...
    public function reject(Request $request, DeliveryMaterial $material): JsonResponse
    {
        ...
        try {
            ...
            ContractNotificationService::notifyCreatorOfDeliveryMaterialRejection($material);
            ContractNotificationService::notifyBrandOfDeliveryMaterialAction($material, 'rejected');
    ...
    public function download(DeliveryMaterial $material): JsonResponse|Response
    {
        $user = $this->getAuthenticatedUser();
